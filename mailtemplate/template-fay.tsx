      ...
      <Tailwind>
        <Body className="font-sans bg-gray-300 ">
          <Container className="bg-white shadow-2xl ">
            ...
            <Container
              className="  min-w-[600px] p-[10px]"
              style={{
                backgroundImage: "url(https://i.imgur.com/2txAriJ.gif)",
                overflow: "hidden",
                zIndex: 9999,
              }}
            >
            ...
            <Row className="text-center align-middle">
              <Column className="align-top w-1/3">
                <Link
                  target="_blank"
                  href="https://www.fay.com/it-it/customer-care/orders-and-shipping/?utm_source=newsletter&utm_medium=email&utm_campaign=%3C%=%20message.delivery.operation.label%20%%3E&utm_content=OP-%3C%=%20message.delivery.operation.internalName%20%%3E%3CRI-%3C%=%20recipient.country_recipient.isoCode%20%%3E%3CDC-%3C%=%20message.delivery.deliveryCode%20%%3E%3CDG-%3C%=%20recipient.gender%20%%3E%3CCC-%3C%=%20message.delivery.operation.campaignCalendario%20%%3E%3CCN-%3C%=%20message.delivery.operation.campaignNature%20%%3E%3Ccontent-Spedizioni&userId=%3C%=recipient.crmId%%3E"
                >
                  <Img
                    src="https://images.todsgroup.com/FayTemplate/icons-footer/Free-shipping.png"
                    alt="Fay"
                    width="51"
                    height="40"
                    className="mx-auto"
                  />
                  <Text className="text-[#162540]">SPEDIZIONE GRATUITA</Text>
                </Link>
              </Column>
              <Column className="align-top w-1/3">
                <Link
                  target="_blank"
                  href="https://www.fay.com/it-it/customer-care/right-of-withdrawal/?utm_source=newsletter&utm_medium=email&utm_campaign=%3C%=%20message.delivery.operation.label%20%%3E&utm_content=OP-%3C%=%20message.delivery.operation.internalName%20%%3E%3CRI-%3C%=%20recipient.country_recipient.isoCode%20%%3E%3CDC-%3C%=%20message.delivery.deliveryCode%20%%3E%3CDG-%3C%=%20recipient.gender%20%%3E%3CCC-%3C%=%20message.delivery.operation.campaignCalendario%20%%3E%3CCN-%3C%=%20message.delivery.operation.campaignNature%20%%3E%3Ccontent-ResoGratuito&userId=%3C%=recipient.crmId%%3E"
                >
                  <Img
                    src="https://images.todsgroup.com/FayTemplate/icons-footer/Cambio-Reso-Online.png"
                    alt="Fay"
                    width="40"
                    height="40"
                    className="mx-auto"
              ...
              <Column className="align-top w-1/3">
                <Link
                  target="_blank"
                  href="https://www.fay.com/it-it/customer-care/payments/?utm_source=newsletter&utm_medium=email&utm_campaign=%3C%=%20message.delivery.operation.label%20%%3E&utm_content=OP-%3C%=%20message.delivery.operation.internalName%20%%3E%3CRI-%3C%=%20recipient.country_recipient.isoCode%20%%3E%3CDC-%3C%=%20message.delivery.deliveryCode%20%%3E%3CDG-%3C%=%20recipient.gender%20%%3E%3CCC-%3C%=%20message.delivery.operation.campaignCalendario%20%%3E%3CCN-%3C%=%20message.delivery.operation.campaignNature%20%%3E%3Ccontent-Pagamentisicuri&userId=%3C%=recipient.crmId%%3E"
                >
                  <Img
                    src="https://images.todsgroup.com/FayTemplate/icons-footer/Pagamenti-sicuri.png"
                    alt="Fay"
                    width="40"
                    height="40"
                    className="mx-auto"
                  />
                  <Text className="text-[#162540]">PAGAMENTI SICURI</Text>
                </Link>
              </Column>
            </Row>
            ...
            <Row className="text-center w-fit mx-auto py-6">
              <Column className="w-[2.313rem]">
                <Link target="_blank" href="https://www.facebook.com/fay">
                  <Img
                    ...
                    alt="Facebook"
                    src="https://images.todsgroup.com/FayTemplate/Social/Facebook.png"
                    width="10px"
                    height="20px"
                  />
                </Link>
              ...
              <Column className="w-[2.313rem]">
                <Link
                  target="_blank"
                  href="https://www.instagram.com/fay_brand/"
                >
                  <Img
                    className="m-0 inline p-0"
                    alt="Instagram"
                    src="https://images.todsgroup.com/FayTemplate/Social/Instagram.png"
                    width="20px"
                    height="20px"
                  />
                </Link>
              ...
              <Column className="w-[2.313rem]">
                <Link
                  target="_blank"
                  href="https://www.pinterest.com/faybrand/"
                >
                  <Img
                    className="m-0 inline p-0"
                    alt="Pinterest"
                    src="https://images.todsgroup.com/FayTemplate/Social/Pinterest.png"
                    width="16px"
                    height="20px"
                  />
                </Link>
              ...
              <Column className="w-[2.313rem]">
                <Link target="_blank" href="https://www.youtube.com/c/fay">
                  <Img
                    className="m-0 inline p-0"
                    alt="Youtube"
                    src="https://images.todsgroup.com/FayTemplate/Social/Youtube.png"
                    width="29px"
                    height="20px"
                  />
                </Link>
            ...
            <Section>
              <Text className="text-center text-[#162540] leading-[0.875rem] text-[0.625rem]">
                ...
                <br />
                Se non vuoi più ricevere comunicazioni da Fay,{" "}
                <Link
                  className="no-underline text-[#162540]"
                  href="https://www.fay.com/unsubscribe-page/?idLang=1040&id=%3C%=%20encryptedCrmIdSuffix%%3E&utm_source=newsletter&utm_medium=email&utm_campaign=%3C%=%20message.delivery.operation.label%20%%3E&utm_content=OP-%3C%=%20message.delivery.operation.internalName%20%%3E%3CRI-%3C%=%20recipient.country_recipient.isoCode%20%%3E%3CDC-%3C%=%20message.delivery.deliveryCode%20%%3E%3CDG-%3C%=%20recipient.gender%20%%3E%3CCC-%3C%=%20message.delivery.operation.campaignCalendario%20%%3E%3CCN-%3C%=%20message.delivery.operation.campaignNature%20%%3E%3Ccontent-Unsubscribe&userId=%3C%=recipient.crmId%%3E"
                  target="_blank"
                >
                  clicca qui.
                </Link>
                <br />
                <br />
                Tod's S.p.a. Via Filippo Della Valle, 1, 63811 S. Elpidio a Mare
                (FM) Italy
              </Text>
            </Section>
          </Container>
